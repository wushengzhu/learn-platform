    ...
    if (values) {
      const formData = {
        ...
        businessLicense: values.businessLicense
          ...
          : "",
        shopFrontImg:
          values?.orgFrontImg?.map((item: UploadFile) => ({ url: item.url })) ||
          [],
        shopRoomImg:
          values?.orgRoomImg?.map((item: UploadFile) => ({ url: item.url })) ||
          [],
        shopOtherImg:
          values?.orgOtherImg?.map((item: UploadFile) => ({ url: item.url })) ||
          [],
      } as IShop;
      edit(id, formData);
    }
